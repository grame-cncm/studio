"""Build Stereo Upmix 2 to 3, adaptive center extraction for PureData.
...
def build_patch(project):
    """Build the PureData patch for Stereo Upmix 2 to 3, adaptive center extraction in memory.
    ...
    independent noises)
    → upmix → FL M1 (11), FR M2 (12), C AtmoC (28). Faust audio outlet c+1 reaches dac~ inlet c, played on the c-th listed output.
