"""Build global panning, eight inputs to sixteen speakers for Max/MSP.
...
def build_patch(project):
    """Build the Max/MSP patch for global panning, eight inputs to sixteen speakers in memory.
