"""Build polyphonic additive MIDI synthesis, sixteen voices for Max/MSP.
...
def build_patch(project):
    """Build the Max/MSP patch for polyphonic additive MIDI synthesis, sixteen voices in memory.
