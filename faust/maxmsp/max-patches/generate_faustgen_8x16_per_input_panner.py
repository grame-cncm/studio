"""Build independent VBAP for eight inputs and sixteen speakers for Max/MSP.
...
def build_patch(project):
    """Build the Max/MSP patch for independent VBAP for eight inputs and sixteen speakers in memory.
