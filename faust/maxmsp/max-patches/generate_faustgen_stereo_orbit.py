"""Build Stereo Orbit, stereo motion across eight speakers for Max/MSP.
...
def build_patch(project):
    """Build the Max/MSP patch for Stereo Orbit, stereo motion across eight speakers in memory.
