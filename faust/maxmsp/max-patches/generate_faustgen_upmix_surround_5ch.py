"""Build Stereo Upmix 2 to 5.0, center and decorrelated surrounds for Max/MSP.
...
def build_patch(project):
    """Build the Max/MSP patch for Stereo Upmix 2 to 5.0, center and decorrelated surrounds in memory.
    ...
    independent noises)
    → upmix → FL M1 (11), FR M2 (12), C AtmoC (28), Ls M3 (13), Rs M4 (14). mc.dac~ sends MC channel c to the c-th listed hardware output.
