...
6. **[`faust/`](faust/README-en.md)** — instruments and effects with common Faust
   sources and Python-generated patches for two environments:

   - [Max/MSP with py2max and mc.faustgen~](faust/maxmsp/README-en.md);
   - [PureData with py2pd and faustgen2~](faust/puredata/README-en.md).

   The [common workflow](faust/README-en.md#a-common-workflow) explains how to
   edit the DSP and generate patches for both environments. Dependencies,
   including abclib, are included as Git submodules.
